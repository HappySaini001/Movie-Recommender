...
Instant search suggestions for quick movie selection.

📝 Movie Details

Displays posters, cast, genres, runtime, and ratings by fetching real-time data from TMDB.

💬 User Reviews

Scrapes audience reviews from IMDB using Jsoup.

😀 Sentiment Analysis

Uses simple keyword-based heuristics to classify reviews as Good or Bad.
